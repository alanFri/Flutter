...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    CameraPlugin *instance = [[CameraPlugin alloc] initWithRegistry:[registrar textures] messenger:[registrar messenger]];
    
    OrientationStreamHandler *orientationStreamHandler =
            [[OrientationStreamHandler alloc] init];
    FlutterEventChannel *orientationChannel = [FlutterEventChannel eventChannelWithName:@"camera-plugin/orientation"
    ...
    FlutterEventChannel *videoRecordingChannel = [FlutterEventChannel eventChannelWithName:@"camera-plugin/video-recording"
    binaryMessenger:[registrar messenger]];
    ...
    FlutterEventChannel *imageStreamChannel = [FlutterEventChannel eventChannelWithName:@"camera-plugin/images"
    binaryMessenger:[registrar messenger]];
    [imageStreamChannel setStreamHandler:imageStreamHandler];
    
    // TODO: Change to "camera-plugin/methods"
    FlutterMethodChannel *methodChannel = [FlutterMethodChannel methodChannelWithName:@"camera-plugin" binaryMessenger:[registrar messenger]];
    [registrar addMethodCallDelegate:instance channel:methodChannel];
}

- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    if (_dispatchQueue == nil) {
        _dispatchQueue = dispatch_queue_create("camera-plugin.dispatchqueue", NULL);
    }
