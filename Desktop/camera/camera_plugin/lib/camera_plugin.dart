...
class CameraPlugin {
  static const MethodChannel _channel = const MethodChannel('camera-plugin');

  static const EventChannel _orientationChannel =
      const EventChannel('camera-plugin/orientation');

  static const EventChannel _permissionsChannel =
      const EventChannel('camera-plugin/permissions');

  static const EventChannel _imagesChannel =
      const EventChannel('camera-plugin/images');

  static const EventChannel _luminosityChannel =
      const EventChannel('camera-plugin/luminosity');
  ...
  static Future<bool> checkPermissions() async {
    try {
      if (Platform.isAndroid) {
        var missingPermissions = await CameraPlugin.checkAndroidPermissions();
        ...
        return CameraPlugin.checkiOSPermissions();
      }
    } catch (e) {
